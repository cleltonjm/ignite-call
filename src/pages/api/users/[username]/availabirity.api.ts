...
export default async function handle(
    ...
    const blockedTimes = await prisma.scheduling.findMany({
        ...
        where: {
            user_id: user.id,
            date: {
                gte: referenceDate.set('hour', startHour).add(timezoneOffsetInHours, 'hours').toDate(), // greater than or equal
                lte: referenceDate.set('hour', endHour).add(timezoneOffsetInHours, 'hours').toDate(), // less than or equal
            },
        },
    })
